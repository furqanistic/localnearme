        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8'>
            ...
            <div className='flex items-center gap-4'>
              <a
                href='javascript:;'
                className='p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-deep-purple-500 hover:text-white focus-within:outline-0 focus-within:bg-deep-purple-500 focus-within:text-white'
              >
                <svg
              ...
              <a
                href='javascript:;'
                className='p-3 rounded-full bg-white text-gray-900 group transition-all duration-500 hover:bg-deep-purple-500 hover:text-white focus-within:outline-0 focus-within:bg-deep-purple-500 focus-within:text-white'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='20'
              ...
              <div className=''>
                ...
                <ul className='flex flex-col max-lg:items-center gap-6'>
                  <li>
                    <a
                      href='javascript:;'
                      className='text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-deep-purple-400 focus-within:outline-0 focus-within:text-deep-purple-400'
                    >
                      Home
                    </a>
                  </li>
              ...
              <div className=''>
                ...
                <ul className='flex flex-col gap-6 max-lg:items-center'>
                  <li>
                    <a
                      href='javascript:;'
                      className='text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-deep-purple-400 focus-within:outline-0 focus-within:text-deep-purple-400'
                    >
                      AirBnB
                    </a>
                  </li>
                ...
                <form action='#' className='flex flex-col gap-5'>
                  ...
                  <div className='flex flex-col min-[540px]:flex-row items-center justify-between gap-3'>
                    ...
                    <input
                      type='submit'
                      value='Send'
                      className='text-white text-base font-semibold py-3 px-7 rounded-full cursor-pointer bg-deep-purple-500 transition-all duration-500 hover:bg-white hover:text-gray-900'
                    />
                  </div>
                </form>
              </div>
          ...
          <div className='flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7'>
            <span className='text-sm font-normal text-gray-400'>
              <a className=''>©localnearme</a> 2024, All rights reserved.
            </span>
